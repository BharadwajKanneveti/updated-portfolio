...
export const DATA = {
  ...
  contact: {
    email: "bharadwajkanneveti@gmail.com",
    tel: "(+91)8688721568",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/BharadwajKanneveti",
        icon: Icons.github,
        navbar: true,
      },
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/k-v-s-bharadwaj-48789a19a/",
        icon: Icons.linkedin,
      ...
      email: {
        name: "Send Email",
        url: "mailto:bharadwajkanneveti@gmail.com",
        icon: Icons.email,
  ...
  projects: [
    ...
    // },
    {
      title: "Concurrent Worker Queue System",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/BharadwajKanneveti/Worker-Queue",
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/BharadwajKanneveti/Rate-Limiting",
          icon: <Icons.github className="size-3" />,
        },
      ],
      // image: "",
